...
description: "Deep dive into a 31,000+ image dataset for second-hand clothing classification, including interactive exploration, Python code examples, and applications in sustainable fashion."
...
format:
  html:
    metadata:
      ...
      og:description: "Deep dive into a 31,000+ image dataset for second-hand clothing classification, including interactive exploration, Python code examples, and applications in sustainable fashion."
      og:type: "article"
      ...
      twitter:description: "Deep dive into a 31,000+ image dataset for second-hand clothing classification, including interactive exploration, Python code examples, and applications in sustainable fashion."
